        ...
        <div className="flex flex-col gap-3">
          <div className="bg-slate-800 rounded-xl p-4">
            ...
            <p className="text-slate-500 text-xs mb-3">
              {gameSettings.quiz_unlocked ? '🟢 Открыта — участники проходят индивидуально' : '🔒 Закрыта'}
            </p>
          ...
          <div className="bg-slate-800 rounded-xl p-4">
            ...
            <p className="text-slate-500 text-xs mb-3">
              {gameSettings.filword_unlocked ? '🟢 Открыт — участники проходят индивидуально' : '🔒 Закрыт'}
            </p>
            ...
            {gameSettings.filword_unlocked ? (
              ...
              <button
                onClick={() => toggleGame('filword', true)}
                disabled={busy}
                className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-medium rounded-lg py-2.5 text-sm transition-colors disabled:opacity-50"
              >
